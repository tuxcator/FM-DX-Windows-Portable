...
function loadConfig() {
    try {
        ...
        if (![120, 140, 160, 190].includes(Number(pluginConfig.analogBandwidthKhz))) pluginConfig.analogBandwidthKhz = 190;
        ...
        try {
            ...
            switch (msg.type) {
                ...
                case 'hd-radio-bandwidth': {
                    ...
                    if (pluginConfig.receiver !== 'airspyhf' || ![120, 140, 160, 190].includes(bandwidth)) {
                    ...
                    hdLogInfo(`Analog DX filter -> ${bandwidth} kHz (live, HD and spectrum IQ unchanged)`);
                    broadcastMeta();
                    break;
                }
